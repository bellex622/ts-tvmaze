...
var MISSING_IMAGE_URL = "https://tinyurl.com/tv-missing";
                ...
                case 1:
                    ...
                    results = data.map(function (result) {
                        ...
                        return ({
                            ...
                            image: ((_a = result.show.image) === null || _a === void 0 ? void 0 : _a.medium) || MISSING_IMAGE_URL
                        });
                    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    results = data.map(function (episode) { return ({
                        id: episode.id,
                        name: episode.name,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    $btn = $(evt.target);
                    id = $btn.closest(".Show").data("showId");
                    console.log("id=", id);
                    return [4 /*yield*/, searchForEpisodesAndDisplay(id)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
